...
#   "$PY" scripts/desktop/desktop-control.py open [url]      # 默认浏览器打开（默认 http://localhost:5173/）
#   "$PY" scripts/desktop/desktop-control.py windows         # 列出可见窗口标题
#   "$PY" scripts/desktop/desktop-control.py activate <关键词>   # 激活目标窗口 —— **每次操作前必做**
#   "$PY" scripts/desktop/desktop-control.py size
#   "$PY" scripts/desktop/desktop-control.py screenshot .tmp-shot.png
#   "$PY" scripts/desktop/desktop-control.py click 640 420 [left|right|double]
#   "$PY" scripts/desktop/desktop-control.py move 640 420
#   "$PY" scripts/desktop/desktop-control.py type "要输入的文本"     # 中文走剪贴板
#   "$PY" scripts/desktop/desktop-control.py key enter
#   "$PY" scripts/desktop/desktop-control.py hotkey ctrl v
#   "$PY" scripts/desktop/desktop-control.py scroll -600
#   "$PY" scripts/desktop/desktop-control.py active                     # 当前窗口标题
#
# 安全：
