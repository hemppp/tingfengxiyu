...
//
// 用法：
//   node scripts/clean-orphan-project-dbs.mjs --list    # 只看
//   node scripts/clean-orphan-project-dbs.mjs           # 执行（文件送回收站）
//
...
if (left.length) {
  ...
  console.log('   node scripts/clean-orphan-project-dbs.mjs');
} else {
  console.log('\n✅ 全部清理完成');
}
