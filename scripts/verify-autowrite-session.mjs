...
// 模型输出是链路的一部分。见 docs/ai-writing-handover.md §3。
//
// 前置条件：
...
//
// 用法：
//   node scripts/verify-autowrite-session.mjs [章数，默认 2]
//
...
console.log(`⚠️  记得清理：node scripts/verify-autowrite-cleanup.mjs ${USERNAME} ${projectId}`);
