...
const TEMPLATES: Template[] = [
  {
    kind: 'mountains',
    label: '远山',
    gradient: ['#e8e3d4', '#c8c0ad', '#8e8a78'],
    ink: 'rgba(40, 50, 38, 0.78)',
    inkSoft: 'rgba(40, 50, 38, 0.32)',
    seal: '#9d4a3a',
  },
  {
    kind: 'bamboo',
    label: '竹影',
    gradient: ['#dde8d0', '#a3bd9d', '#5e7a5d'],
    ink: 'rgba(28, 46, 32, 0.82)',
    inkSoft: 'rgba(28, 46, 32, 0.30)',
    seal: '#7a3a32',
  },
  {
    kind: 'clouds',
    label: '云海',
    gradient: ['#f4f1e7', '#d8d8cc', '#a3a89e'],
    ink: 'rgba(50, 56, 50, 0.72)',
    inkSoft: 'rgba(50, 56, 50, 0.28)',
    seal: '#8a4a3a',
  },
  {
    kind: 'moon',
    label: '秋月',
    gradient: ['#e4dac4', '#b8a98e', '#6b6557'],
    ink: 'rgba(38, 34, 28, 0.82)',
    inkSoft: 'rgba(38, 34, 28, 0.32)',
    seal: '#a04030',
  },
  {
    kind: 'pagoda',
    label: '古寺',
    gradient: ['#e6d8b8', '#b9a378', '#6e5a3e'],
    ink: 'rgba(46, 30, 18, 0.82)',
    inkSoft: 'rgba(46, 30, 18, 0.32)',
    seal: '#7a2820',
  },
  {
    kind: 'rain',
    label: '听雨',
    gradient: ['#d8dcd0', '#a6b0a0', '#6a7868'],
    ink: 'rgba(34, 42, 36, 0.80)',
    inkSoft: 'rgba(34, 42, 36, 0.30)',
    seal: '#7a3830',
  },
  {
    kind: 'waves',
    label: '碧波',
    gradient: ['#d6e0d0', '#94a89e', '#4a5e58'],
    ink: 'rgba(20, 32, 30, 0.82)',
    inkSoft: 'rgba(20, 32, 30, 0.30)',
    seal: '#883a30',
  },
  {
    kind: 'plum',
    label: '寒梅',
    gradient: ['#ecdcd0', '#c8a89a', '#7a5a52'],
    ink: 'rgba(50, 28, 28, 0.80)',
    inkSoft: 'rgba(50, 28, 28, 0.30)',
    seal: '#9a2a22',
  },
];
